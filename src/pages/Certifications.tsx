...
const Certifications: React.FC = () => {
  ...
  if (certifications === null) return <div>Loading...</div>;
  if (certifications.length === 0) return <div className="certifications-container"><p style={{color:'#fff', textAlign:'center', paddingTop:'4rem'}}>No certifications added yet.</p></div>;
